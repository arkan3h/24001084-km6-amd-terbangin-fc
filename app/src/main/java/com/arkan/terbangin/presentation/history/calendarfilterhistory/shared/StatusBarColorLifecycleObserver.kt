...
import com.arkan.terbangin.presentation.history.calendarfilterhistory.getColorCompat
...
class StatusBarColorLifecycleObserver(
    ...
    private val defaultStatusBarColor = activity.getColorCompat(R.color.md_theme_onSecondaryFixed)
