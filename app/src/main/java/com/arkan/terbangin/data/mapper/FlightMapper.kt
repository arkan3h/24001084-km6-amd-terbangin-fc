...
fun FlightDataResponse?.toFlight() =
    Flight(
        ...
        airlineSerialNumber = this?.flightCode.orEmpty(),
        airlineId = this?.airline?.id.orEmpty(),
        airlineCode = this?.airline?.iataCode.orEmpty(),
        ...
        endAirportCode = this?.endAirport?.iataCode.orEmpty(),
        ...
        startAirportCode = this?.startAirport?.iataCode.orEmpty(),
