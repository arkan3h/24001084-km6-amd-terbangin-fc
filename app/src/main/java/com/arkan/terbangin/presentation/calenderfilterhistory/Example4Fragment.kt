...
import com.arkan.terbangin.databinding.Example4CalendarDayBinding
import com.arkan.terbangin.databinding.Example4CalendarHeaderBinding
import com.arkan.terbangin.databinding.Example4FragmentBinding
import com.arkan.terbangin.presentation.calenderfilterhistory.shared.ContinuousSelectionHelper.getSelection
import com.arkan.terbangin.presentation.calenderfilterhistory.shared.ContinuousSelectionHelper.isInDateBetweenSelection
import com.arkan.terbangin.presentation.calenderfilterhistory.shared.ContinuousSelectionHelper.isOutDateBetweenSelection
...
class Example4Fragment : BaseFragment(R.layout.example_4_fragment), HasBackButton {
    ...
    override fun onCreateOptionsMenu(
        ...
        binding.exFourToolbar.post {
            ...
            binding.exFourToolbar.findViewById<TextView>(R.id.menuItemClear).apply {
                setTextColor(requireContext().getColorCompat(R.color.md_theme_outline))
    ...
    override fun onStart() {
        super.onStart()
        val closeIndicator =
            requireContext().getDrawableCompat(R.drawable.ic_clear).apply {
                colorFilter =
                    BlendModeColorFilterCompat.createBlendModeColorFilterCompat(
                        requireContext().getColorCompat(R.color.md_theme_outline),
                        ...
                        DayPosition.MonthDate -> {
                            ...
                            if (data.date.isBefore(today)) {
                                ...
                                when {
                                    ...
                                    else -> textView.setTextColorRes(R.color.md_theme_outline)
                                }
                            }
                        }
