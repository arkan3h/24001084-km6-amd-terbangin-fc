...
class SeatBookView
    ...
    LinearLayout(context, attrs) {
        ...
        init {
            inflate(context, R.layout.layout_view_group_for_seat, this)
        ...
        fun setSeatSizeBySeatsColumnAndLayoutWidth(
            seatsInColumn: Int,
            parentLayoutWeight: Int,
        ) {
            seatSize =
                if (parentLayoutWeight != -1) {
