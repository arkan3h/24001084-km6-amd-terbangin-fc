...
class SearchHistoryRepositoryImplTest {
    ...
    private val mockHistory1 = SearchHistoryEntity(1, "query1", System.currentTimeMillis())
    private val mockHistory2 = SearchHistoryEntity(2, "query2", System.currentTimeMillis())
    ...
    fun setUp() {
        ...
        repo = SearchHistoryRepositoryImpl(dataSource)
    }
    ...
    fun getSearchHistoryEmpty() {
        val mockHistoryList = listOf<SearchHistoryEntity>()
        val mockFlow = flow { emit(mockHistoryList) }
